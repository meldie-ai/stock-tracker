...
export default async function ProductsSoldPage() {
  ...
  // This page is a server-rendered snapshot, not a live view — it only reflects sold
  // counts as of whenever it was last loaded/refreshed. Stamp that moment so it's clear
  // how current the numbers actually are if the page has been sitting open a while.
